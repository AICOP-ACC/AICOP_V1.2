		                      ...
		                      <div class="card">
							        ...
							        <div class="card-body">
							          ...
							          <div class="material-datatables">
							            ...
							            <div class="row">
							            <div class="col-sm-12"><table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
							              ...
							              <tr role="row" class="odd">
							                  <td tabindex="0" class="sorting_1">Analysis point out issue in weblogic</td>
							                  <td>commandcenter	</td>
							                  <td>02/08/18 09:43:22</td>
							                 
							                </tr><tr role="row" class="even">
							                  <td class="sorting_1" tabindex="0">Weblogic went down due to the stuck threads</td>
							                  <td>commandcenter</td>
							                  <td>02/08/18 09:43:22</td>
							                   </tr><tr role="row" class="odd">
							                  <td tabindex="0" class="sorting_1">OPOM team to verify weblogic status	</td>
							                  <td>commandcenter</td>
							                  <td>01/08/18 19:12:21</td>
							                  
							                </tr><tr role="row" class="even">
							                  <td class="sorting_1" tabindex="0">Issue was caused due to weblgic issue in MTS</td>
							                  <td>commandcenter</td>
							                  <td>01/08/18 19:12:21</td>
							                  ...
							                  <td class="sorting_1" tabindex="0">Long Running to be checked in MTS</td>
							                  <td>commandcenter</td>
							                  <td>01/08/18 19:12:21</td>
